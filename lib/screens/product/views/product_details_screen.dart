...
import 'package:flutter_ecommerce_ui_o/screens/product/views/product_returns_screen.dart';
...
class ProductDetailsScreen extends StatelessWidget {
  const ProductDetailsScreen({super.key, this.isProductAvailable = true,  this.product});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      bottomNavigationBar: isProductAvailable
          ? CartButton(
              price: product?.priceAfetDiscount?.toDouble() ?? product!.price.toDouble(),
              press: () {
            ...
            SliverAppBar(
              ...
              actions: [
                IconButton(
                  ...
                  icon: Obx(() => Icon(
                    bookmarkController.isBookmarked(product!)
                        ? Icons.bookmark
